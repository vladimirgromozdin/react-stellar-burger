            ...
            <nav className={styles.navElement}>
                <ul className={`${styles.leftNav} text mb-20`}>
                    <Link className={styles.link} to='/profile'>
                        <li className={`${styles.navItem} text_type_main-medium ${!matchProfile ? 'text_color_inactive' : ''}`}>Профиль</li>
                    </Link>
                    <Link className={styles.link} to='/profile/orders'>
                        <li className={`${styles.navItem} text_type_main-medium ${!matchProfileOrders ? 'text_color_inactive' : ''}`}>История заказов
                        </li>
                    </Link>
